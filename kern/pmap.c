...
mem_init(void)
{
	...
	cprintf("page table initial completed!!!\n");
	//////////////////////////////////////////////////////////////////////
	...
	//boot_map_region(kern_pgdir, KSTACKTOP-PTSIZE, PTSIZE-KSTKSIZE, KERNBASE, ~0);
	//////////////////////////////////////////////////////////////////////
...
page_init(void)
{
	...
	cprintf("base page init complete\n");
	...
	cprintf("unused page init completed\n");
